    ...
    private void mainMenu() {
        ...
        while (playAgain.equals("y")) {
            ...
            if (game.getWinner() != null) {  // check for null just to be safe (so we don't call a method on null)
                ...
                if (game.getWinner().getConsecutiveWins() > 1){
                    System.out.println("On a " + game.getWinner().getConsecutiveWins() + "win streak!");
                }
            }
            System.out.println("~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~");
            ...
            if (playAgain != "y" || playAgain != "n"){
                System.out.println("Please answer in either y or n");
            }
        }
